...
namespace _3DSExplorer.Crypt
{
    ...
    public class QuickCrc32
    {
        public delegate void ProcessFinished(uint result);
        ...
        private static readonly uint[] CRCTable =
       {
        ...
        private void BwDoWork(object sender, DoWorkEventArgs e)
        {
            ...
            while (readBytes > 0)
            {
                ...
                _bw.ReportProgress((int) (100*(float) fs.Position/fs.Length));
            }
            fs.Close();
